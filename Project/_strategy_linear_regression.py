...
class StrategyLinearRegressionMultiAgent:
    def __init__(self, asset, dif_time, data, train_duration, test_duration, model, thresold) -> None:
        self.asset = asset
    ...
    def execution_of_strategy(self):
        ...
        for i, (train_set, test_set) in enumerate(self.datasets):
            ...
            strategy = StrategyLinearRegression(
                self.asset, self.dif_time, train_set, y_train, test_set, self.model, self.data.index)
            strategy.train()
...
class StrategyLinearRegression:
    ...
    def __init__(self, asset, dif_time, data_train, y_train, data_trade, model, index_all) -> None:
